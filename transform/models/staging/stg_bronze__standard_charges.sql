select
    ...
    {{ hpt_safe_double('minimum') }} as minimum,
    {{ hpt_safe_double('maximum') }} as maximum,
    {{ hpt_safe_double('gross_charge') }} as gross_charge,
    {{ hpt_safe_double('discounted_cash') }} as discounted_cash,
