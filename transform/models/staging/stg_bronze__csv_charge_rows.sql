with staged as (
    select
        ...
        {{ hpt_clean_text('drug_type_of_measurement') }} as clean_drug_unit_type,
        {{ hpt_safe_double('standard_charge_gross') }} as gross_charge,
        {{ hpt_safe_double('standard_charge_discounted_cash') }} as discounted_cash,
        {{ hpt_safe_double('standard_charge_min') }} as minimum,
        {{ hpt_safe_double('standard_charge_max') }} as maximum,
        ...
        {{ hpt_safe_double('standard_charge_negotiated_dollar') }} as negotiated_dollar,
