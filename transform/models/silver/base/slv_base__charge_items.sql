with json_items as (
    select
        ...
        cast(null as varchar) as raw_billing_class,
        cast(null as varchar) as clean_billing_class,
        di.drug_unit,
...
csv_items as (
    select
        ...
        r.clean_description,
        any_value(r.raw_setting) as raw_setting,
        r.clean_setting,
        any_value(r.raw_billing_class) as raw_billing_class,
